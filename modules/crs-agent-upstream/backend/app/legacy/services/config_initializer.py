...
ACTIVE_SYSTEM_CONFIGS: tuple[dict[str, Any], ...] = (
    ...
    _spec(
        "frontend_eruda_enabled",
        value=settings.frontend_eruda_enabled,
        type_="bool",
        category="frontend",
        description="是否在用户端启用 Eruda 移动调试控制台",
    ),
    _spec(
        "frontend_webview_debug_enabled",
        value=settings.frontend_webview_debug_enabled,
        type_="bool",
        category="frontend",
        description="是否在用户端展示 WebView 图内搜索调试按钮",
    ),
    _spec(
        "frontend_webview_debug_url",
        value=settings.frontend_webview_debug_url,
        type_="string",
        category="frontend",
        description="用户端 WebView 调试按钮默认打开的文档链接",
    ),
    _spec(
        "frontend_webview_debug_pdf_id",
        value=settings.frontend_webview_debug_pdf_id,
        type_="string",
        category="frontend",
        description="用户端 WebView 调试文档对应的图内搜索 pdf_id",
    ),
    _spec(
        "agent_model",
    ...
    _spec(
        ...
        value=settings.circuit_diagram_body_search_enabled,
        type_="bool",
        category="external_service",
        description="是否启用电路图内搜索外部服务",
    ),
    _spec(
        "circuit_diagram_body_search_url",
        value=settings.circuit_diagram_body_search_url,
        type_="string",
        category="external_service",
        description="电路图内搜索接口地址（POST，入参 pdf_id/keyword）",
    ),
    _spec(
        "circuit_diagram_body_search_timeout",
        value=settings.circuit_diagram_body_search_timeout,
        type_="int",
        category="external_service",
        description="电路图内搜索请求超时时间（秒）",
    ),
    _spec(
        "circuit_diagram_body_search_pg_host",
        value=settings.circuit_diagram_body_search_pg_host,
        type_="string",
        category="external_service",
        description="电路图解析库 PostgreSQL 主机",
    ),
    _spec(
        "circuit_diagram_body_search_pg_port",
        value=settings.circuit_diagram_body_search_pg_port,
        type_="int",
        category="external_service",
        description="电路图解析库 PostgreSQL 端口",
    ),
    _spec(
        "circuit_diagram_body_search_pg_database",
        value=settings.circuit_diagram_body_search_pg_database,
        type_="string",
        category="external_service",
        description="电路图解析库 PostgreSQL 数据库名",
    ),
    _spec(
        "circuit_diagram_body_search_pg_user",
        value=settings.circuit_diagram_body_search_pg_user,
        type_="string",
        category="external_service",
        description="电路图解析库 PostgreSQL 用户名",
    ),
    _spec(
        "circuit_diagram_body_search_pg_password",
        value=settings.circuit_diagram_body_search_pg_password,
        type_="string",
        category="external_service",
        description="电路图解析库 PostgreSQL 密码",
        is_sensitive=True,
    ),
    _spec(
        "circuit_diagram_body_search_pg_connect_timeout",
        value=settings.circuit_diagram_body_search_pg_connect_timeout,
        type_="int",
        category="external_service",
        description="电路图解析库 PostgreSQL 连接超时时间（秒）",
    ),
    _spec(
        "circuit_diagram_body_preview_token_ttl_seconds",
        value=settings.circuit_diagram_body_preview_token_ttl_seconds,
        type_="int",
        category="external_service",
        description="电路图内搜索局部图预览 token 有效期（秒）",
    ),
    _spec(
        "circuit_diagram_body_preview_result_base_dir",
        value=settings.circuit_diagram_body_preview_result_base_dir,
        type_="string",
        category="external_service",
        description="电路图解析结果文件基础目录；为空时使用当前服务目录和项目目录兜底",
    ),
    _spec(
        "circuit_diagram_body_preview_pdf_timeout",
        value=settings.circuit_diagram_body_preview_pdf_timeout,
        type_="int",
        category="external_service",
        description="电路图局部图从 PDF 地址渲染时的下载超时时间（秒）",
    ),
    _spec(
